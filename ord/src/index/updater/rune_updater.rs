...
pub(super) struct RuneUpdater<'a, 'db, 'tx> {
  ...
  pub(super) inscription_id_to_sequence_number: &'a Table<'db, 'tx, InscriptionIdValue, u64>,
  ...
  pub(super) runes: u64,
  pub(super) sequence_number_to_rune_id: &'a mut Table<'db, 'tx, u64, RuneIdValue>,
